...
#from http://www.leeholmes.com/blog/2007/06/19/invoking-generic-methods-on-non-generic-classes-in-powershell/
...
# Write-Host $method.Name
  if(($method.Name -eq $methodName) -and ($method.IsPublic) -and ($method.IsGenericMethod))
  {
...
## Invoke the method
      return $newMethod.Invoke($instance, $methodParameters)
